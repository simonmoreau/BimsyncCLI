...
namespace BimsyncCLI.RevisionCmd
{
    ...
    class RevisionListCmd : bimsyncCmdBase
    {
        ...
        public RevisionListCmd(ILogger<RevisionCmd> logger, IConsole console, IHttpClientFactory clientFactory, IBimsyncClient bimsyncClient, SettingsService settingsService)
        {
            _logger = logger;
            _console = console;
